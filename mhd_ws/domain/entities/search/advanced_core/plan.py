...
class MetaboliteIdStage(BaseModel):
    ...
    index_key: str = "metabolite-index"
...
class DatasetIdConstraint(BaseModel):
    ...
    from_stage_id: str = "stage_metabolite_ids"
...
class DatasetSearchStage(BaseModel):
    ...
    index_key: str = "ms-dataset-index"
...
class QueryPlan(BaseModel):
    ...
    final_stage_id: str = "stage_dataset_search"
